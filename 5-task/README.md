...
-   Аргумент обязательно является либо пустым массивом, либо массивом чисел (`NaN`, бесконечные числа тоже запрещены). При невыполнении этих условий нужно выбросить ошибку с описанием `WrongArgumentType`
